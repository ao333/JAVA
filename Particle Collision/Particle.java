...
public class Particle{
     ...
     * will be p1.r + p2.r.
     * The position of Particle ps at time (now+t) is
     * (ps.x + t*ps.vx, ps.y + t*ps.vy).
     ...
     * If some solution for t is negative, then the ps have already
    ...
    /**
     * Updates two colliding ps from their state immediately prior to
     * collision to their state immediately after. In particular, the velocities
     * of the ps are updated.
     */
    ...
    /**
     * Updates Particle ps from its state immediately before colliding with Wall
