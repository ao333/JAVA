...
public class ParticlesModel {
    ...
    /**
     * Creates a model of size w x h, with ps ps.
     */ 
    ...
    /**
     * Returns the p that are part of this model.
     */
    ...
    /**
     * Returns an iterable object containing all possible collisions that 
     * all p would undergo starting 'now' if they all continued along
